...
def get_live_matches():
    return api_get("https://crickbuzz-official-apis.p.rapidapi.com/matches/live")

def get_scorecard(match_id):
    return api_get(f"https://crickbuzz-official-apis.p.rapidapi.com/matches/live/{match_id}/scard")

def get_match_info(match_id):
    return api_get(f"https://crickbuzz-official-apis.p.rapidapi.com/matches/live/{match_id}")

def get_standings(series_id):
    return api_get(f"https://crickbuzz-official-apis.p.rapidapi.com/matches/live/{series_id}/standings")

def get_commentary(match_id):
    return api_get(f"https://crickbuzz-official-apis.p.rapidapi.com/matches/live/{match_id}/comm")
